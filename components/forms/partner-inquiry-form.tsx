    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="businessName"
            placeholder="Your funeral home or business"
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="message"
          placeholder="Tell us about your business and what you're looking for in a sea burial partner..."
          rows={4}
          {...register('message')}
