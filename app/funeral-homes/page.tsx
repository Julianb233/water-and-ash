...
export const metadata: Metadata = {
  title: 'Funeral Home Partnerships - Refer Sea Burial Services',
  description:
    'Partner with Water & Ash Burials to offer premium sea burial services to your families. Competitive commission structure, dedicated support, and seamless referral process for San Diego funeral homes.',
  openGraph: {
    title: 'Funeral Home Partnerships | Water & Ash Burials',
    description:
      'Expand your service offerings with premium sea burials. Competitive commissions, dedicated support, and a seamless referral process.',
  },
};
...
const partnerBenefits = [
  {
    ...
    description:
      'Earn a generous referral fee for every family you connect with our services. Transparent, reliable payouts.',
  },
  {
    icon: Users,
    title: 'Expanded Service Offerings',
    description:
      'Offer your families a meaningful alternative they may not know exists — without adding overhead to your operations.',
  },
  {
    icon: Shield,
    title: 'Fully Licensed & Insured',
    description:
      'EPA-compliant ceremonies, licensed captains, full liability coverage. Your reputation is safe with us.',
  },
  {
    icon: Clock,
    title: 'Fast Turnaround',
    description:
      'We can schedule ceremonies within days. Flexible timing to accommodate your families\u2019 needs and timelines.',
  },
  {
    icon: Heart,
    title: 'Compassionate Service',
    description:
      'Our team treats every family with the same care and dignity you provide. Grief-sensitive communication at every touchpoint.',
  },
  {
    icon: FileText,
    title: 'Simple Referral Process',
    description:
      'One call or form submission to start. We handle all logistics, permitting, and family coordination from there.',
  },
];
...
const referralSteps = [
  {
    ...
    description:
      'When a family expresses interest in sea burial, simply share our contact information or submit a referral through our partner portal.',
  },
  {
    step: '02',
    title: 'We Take It from Here',
    description:
      'Our team contacts the family within hours, answers their questions, and guides them through the process with compassion and care.',
  },
  {
    step: '03',
    title: 'A Beautiful Ceremony',
    description:
      'We coordinate the entire ceremony — vessel booking, permitting, floral tributes, and personalized touches. The family receives a premium experience.',
  },
  {
    step: '04',
    title: 'You Earn Your Commission',
    description:
      'Once the ceremony is complete, you receive your referral commission. Transparent tracking and reliable, timely payouts every time.',
  },
];
        ...
        <Container className="relative z-10">
          <FadeIn className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-white/85 sm:text-xl max-w-2xl">
              Partner with San Diego&apos;s premier sea burial service. Offer
              your families a compassionate, premium option — and earn a
              competitive commission on every referral.
            </p>
        ...
        <Container>
          <FadeIn className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Add a premium sea burial option to your service offerings with
              zero overhead and full confidence.
            </p>
          </FadeIn>
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <Container className="relative">
          <FadeIn className="mx-auto max-w-2xl text-center">
            <h2 className="font-serif text-3xl font-bold tracking-tight text-foreground sm:text-4xl md:text-5xl">
              How the Referral{' '}
              <span className="text-gradient-gold">Process Works</span>
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              A simple, four-step process that keeps you informed and your
      ...
      <section className="py-20 md:py-28">
        <Container>
          <FadeIn className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              When you refer a family to Water &amp; Ash, you can be confident
              they&apos;ll receive the same standard of care you provide.
            </p>
          </FadeIn>
          ...
          <div className="mx-auto mt-12 max-w-3xl">
            <StaggerContainer className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                'Biodegradable urns and floral tributes included',
                  ...
                  <div className="mt-8 rounded-lg bg-secondary/30 p-6">
                    ...
                    <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                      ...
                      <li className="flex gap-2">
                        ...
                        We finalize the partnership agreement
                      </li>
                      <li className="flex gap-2">
        ...
        <Container className="relative">
          <FadeIn className="mx-auto max-w-3xl text-center">
            <h2 className="font-serif text-3xl font-bold text-white sm:text-4xl md:text-5xl">
              Let&apos;s Serve San Diego Families{' '}
              <span className="text-gradient-gold">Together</span>
            </h2>
            <p className="mt-6 text-lg text-white/80 leading-relaxed">
              Join a growing network of funeral homes who trust Water &amp; Ash
              Burials to provide their families with a dignified, premium sea
              burial experience.
            </p>
