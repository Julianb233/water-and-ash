...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Dignified sea burial ceremonies aboard our flagship 62-foot Striker. Capacity for up to 13 passengers, departing from San Diego Harbor.',
  },
};
  ...
  return (
    <>
      <ServiceStructuredData
        ...
        description="Dignified sea burial aboard a 62-foot Striker with capacity for up to 13 passengers. Includes ceremony coordination, GPS coordinates, certificate, and floral tributes."
        price="2000"
