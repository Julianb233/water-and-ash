...
export const metadata: Metadata = {
  title: 'White Nights - 58ft Hatteras',
  description:
    'A luxurious 58-foot Hatteras motor yacht providing an elegant setting for sea burial ceremonies with capacity for up to 12 passengers.',
};
